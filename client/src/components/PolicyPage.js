const PolicyPage = () => {
    return (
        <div id="policy" className="section section-padding bg-grey overflow-hidden">
            <div className="container">
                <div className="section-title">
                    <h2 className="main-title">Politique de confidentialité</h2>
                </div>
                <div className="col-12">
                    <p className="text-center">DONNÉES PERSONNELLES</p>
                    <h3 className="mt-4 mb-4">Définitions</h3>
                    <p><strong>L'Éditeur</strong> : La personne, physique ou morale, qui édite les services de communication au publicen ligne.</p>
                    ...
                    <h4 className="mt-4 mb-4">1- Nature des données collectées</h4>
                    ...
                    <ol>Données d'état-civil, d'identité, d'identification...</ol>
                    <ol>Données de connexion (adresses IP, journaux d'événements...)</ol>
                    <h4 className="mt-4 mb-4">2- Communication des données personnelles à des tiers</h4>
                    <p><strong>Pas de communication à des tiers</strong></p>
                    <p>Vos données ne font l'objet d'aucune communication à des tiers. Vous êtes toutefois informés
                    qu'elles pourront être divulguées en application d'une loi, d'un règlement ou en vertu d'une
                    décision d'une autorité réglementaire ou judiciaire compétente.</p>
                    <h4 className="mt-4 mb-4">3- Information préalable pour la communication des
                    données personnelles à des tiers en cas de fusion /
                    absorption</h4>
                    <p>Information préalable et possibilité d’opt-out avant et après la fusion / acquisition
                    ...
                    <h4 className="mt-4 mb-4">4- Agrégation des données</h4>
                    <p><strong>Agrégation avec des données non personnelles</strong></p>
                    <p>Nous pouvons publier, divulguer et utiliser les informations agrégées (informations relatives à
                    ...
                    de profilage démographique, à des fins promotionnelles et publicitaires et à d'autres fins commerciales.</p>
                    <p>Agrégation avec des données personnelles disponibles sur les comptes sociaux de
                    l'Utilisateur</p>
                    <p>Si vous connectez votre compte à un compte d’un autre service afin de faire des envois croisés,
                    ...
                    sur l’Utilisateur.</p>
                    <h4 className="mt-4 mb-4">5- Collecte des données d'identité</h4>
                    <p><strong>Consultation libre</strong></p>
                    <p>La consultation du Site ne nécessite pas d'inscription ni d'identification préalable. Elle peut
                    ...
                    pour la simple consultation du Site.</p>
                    <h4 className="mt-4 mb-4">6- Collecte des données d'identification</h4>
                    ...
                    <p>Nous utilisons vos identifiants électroniques pour rechercher des relations présentes par
                    ...
                    d'offre incitative, nous sommes susceptibles de partager votre identifiant électronique.</p>
                    <h4 className="mt-4 mb-4">7- Collecte des données du terminal</h4>
                    <p><strong>Aucune collecte des données techniques</strong></p>
                    <p>Nous ne collectons et ne conservons aucune donnée technique de votre appareil (adresse IP,
                    fournisseur d'accès à Internet...).</p>
                    <h4 className="mt-4 mb-4">8- Cookies</h4>
                    <p><strong>Durée de conservation des cookies</strong></p>
                    <p>Conformément aux recommandations de la CNIL, la durée maximale de conservation des
                    ...
                    l’Utilisateur devra donc être renouvelé à l'issue de ce délai.</p>
                    <p><strong>Finalité cookies</strong></p>
                    <p>Les cookies peuvent être utilisés pour des fins statistiques notamment pour optimiser les
                    ...
                    consultées.</p>
                    <p>Vous êtes informé que l'Éditeur est susceptible de déposer des cookies sur votre terminal. Le
                    ...
                    ultérieures.</p>
                    <p>Droit de l'Utilisateur de refuser les cookies, la désactivation entraînant un
                    fonctionnement dégradé du service.</p>
                    <p>Vous reconnaissez avoir été informé que l'Éditeur peut avoir recours à des cookies, et l'y
                    ...
                    ne plus fonctionner correctement.</p>
                    <p>Association possible des cookies avec des données personnelles pour permettre le
                    fonctionnement du service.</p>
                    <p>L'Éditeur peut être amenée à recueillir des informations de navigation via l'utilisation de
                    cookies.</p>
                    <h4 className="mt-4 mb-4">9 - Conservation des données techniques</h4>
                    <p><strong>Durée de conservation des données techniques</strong></p>
                    <p>Les données techniques sont conservées pour la durée strictement nécessaire à la réalisation
                    des finalités visées ci-avant.</p>
                    <h4 className="mt-4 mb-4">10- Délai de conservation des données personnelles et d'anonymisation</h4>
                    ...
                    conclusion du contrat ou de la durée prédéfinie de la relation contractuelle.</p>
                    <p><strong>Conservation des données anonymisées au delà de la relation contractuelle / après la
                    suppression du compte</strong></p>
                    <p>Nous conservons les données personnelles pour la durée strictement nécessaire à la réalisation
                    ...
                    lieu à aucune exploitation, de quelque nature que ce soit.</p>
                    <p><strong>Suppression des données après suppression du compte</strong></p>
                    <p>Des moyens de purge de données sont mis en place afin d'en prévoir la suppression effective
                    ...
                    <p>Pour des raisons de sécurité, si vous ne vous êtes pas authentifié sur le Site pendant une
                    période de trois ans, vous recevrez un e-mail vous invitant à vous connecter dans les plus brefs
                    délais, sans quoi vos données seront supprimées de nos bases de données.</p>
                    <h4 className="mt-4 mb-4">11- Suppression du compte</h4>
                    <p><strong>Suppression du compte à la demande</strong></p>
                    <p>L'Utilisateur a la possibilité de supprimer son Compte à tout moment, par simple demande à
                    ...
                    <p>En cas de violation d'une ou de plusieurs dispositions de la Politique de Confidentialité ou de tout
                    ...
                    aux services, à votre compte et à tous les Sites.</p>
                    <h4 className="mt-4 mb-4">12- Indications en cas de faille de sécurité décelée par l'Éditeur</h4>
                    <p><strong>Information de l'Utilisateur en cas de faille de sécurité</strong></p>
                    <p>Nous nous engageons à mettre en oeuvre toutes les mesures techniques et organisationnelles
                    ...
                    réalisation des risques identifiés ci-dessus, nous nous engageons à :</p>
                    <ol>- Vous notifier l'incident dans les plus brefs délais ;</ol>
                    <ol>- Examiner les causes de l'incident et vous en informer ;</ol>
                    <p>Prendre les mesures nécessaires dans la limite du raisonnable afin d'amoindrir les effets négatifs
                    et préjudices pouvant résulter dudit incident.</p>
                    <p><strong>Limitation de la responsabilité</strong></p>
                    <p>En aucun cas les engagements définis au point ci-dessus relatifs à la notification en cas de faille
                    ...
                    <h4 className="mt-4 mb-4">13- Transfert des données personnelles à l'étranger</h4>
                    <p><strong>Transfert des données dans des pays avec un niveau de protection équivalent</strong></p>
                    <p>L'Éditeur s'engage à respecter la réglementation applicable relative aux transferts des
                    données vers des pays étrangers et notamment selon les modalités suivantes :</p>
                    <p>L'Éditeur transfère les données personnelles de ses Utilisateurs vers des pays reconnus
                    comme offrant un niveau de protection équivalent.</p>
                    <p>L'Éditeur transfère les données personnelles de ses Utilisateurs en dehors des pays
                    reconnus par la CNIL comme ayant un niveau de protection suffisant : L'Éditeur a obtenu
                    une autorisation de la CNIL pour procéder à ce transfert.</p>
                    <p>Pour connaître la liste de ces pays : CNIL - La protection des données dans le monde <a href="https://www.cnil.fr/fr/la-protection-des-donnees-dans-le-monde">https://www.cnil.fr/fr/laprotection-des-donnees-dans-le-monde</a></p>
                    <h4 className="mt-4 mb-4">14- Modification de la politique de confidentialité</h4>
                    <p>En cas de modification de la présente Politique de Confidentialité, engagement de ne pas
                    baisser le niveau de confidentialité de manière substantielle sans l'information préalable
                    des personnes concernées.</p>
                    <p>Nous nous engageons à vous informer en cas de modification substantielle de la présente
                    Politique de Confidentialité, et à ne pas baisser le niveau de confidentialité de vos données de
                    manière substantielle sans vous en informer et obtenir votre consentement.</p>
                    <h4 className="mt-4 mb-4">15- Droit applicable et modalités de recours</h4>
                    <p><strong>Clause d'arbitrage</strong></p>
                    <p>Vous acceptez expressément que tout litige susceptible de naître du fait de la présente Politique
                    ...
                    <h4 className="mt-4 mb-4">16- Portabilité des données</h4>
                    <p><strong>Portabilité des données</strong></p>
                    <p>L'Éditeur s'engage à vous offrir la possibilité de vous faire restituer l'ensemble des données
                    ...
                    fournies dans un format ouvert et aisément réutilisable.</p>
                </div>
            </div>
        </div>
    )
